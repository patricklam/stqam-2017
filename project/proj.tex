...
\begin{center}
{\bf Due:  11:59 PM, Friday, April 3, 2017 (no late days)} \\
{\bf Group Sign-up Due:  11:59 PM, Monday, February 27, 2017} \\
{\bf Submit: via ecgit}
		
\end{center}

Please go to \url{http://patricklam.ca/se465-groups/1171/project/} to sign up your project group by {\bf 11:59 PM February 27, 2017}.  Choose your own group members (2--3 students per group). The signup page will tell you your repo address and fork the skeleton repo for you.

We have also placed {\tt proj-skeleton.tar.gz} in the course repo, in
case you want to look at the files before committing to a group. But
...
\vspace{0.03in}
{\bf Electronic submission:} Push your project files to your group repo on ecgit. We expect to find:
...
\item in the root of the repo, a single PDF file ``proj\_sub.pdf'' for
  ...
  include your team members' full names, student numbers, the course
  numbers (one of ECE453, CS447, or SE465), and your uwaterloo email
  addresses.
...
Given a bitcode file, you use LLVM {\em opt} to generate call graphs in plain text format,
