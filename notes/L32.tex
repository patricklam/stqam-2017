...
\lecture{32 --- March 24, 2017}{Winter 2017}{Patrick Lam}{version 0 (still DRAFT)}
...
FindBugs, PMD, and other tools enforce generic rules that all software systems should satisfy. You can read a comparison of different tools in this paper:
\begin{center}
