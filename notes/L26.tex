...
\lecture{26 --- March 10, 2017}{Winter 2017}{Patrick Lam}{version 1}
...
was a time before CI. You need \emph{continuous builds} and \emph{test automation} to make CI work.
...
Continuous Deployment is a minor variant to CI where the productiton machines also pull changes
as soon as the tests pass.

\paragraph{Key Details.} Note that CI also requires these practices:
